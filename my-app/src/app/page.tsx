...
const Home: FC = () => {
    ...
    return (
        <div
            ...
            style={{
                backgroundImage: `url(https://wallpapers.com/images/featured/4k-social-media-59t5e2lfen5uty95.jpg)`, // Replace with your image URL
            ...
            <div className="flex h-[100vh] pt-24">
                ...
                <div ref={heroRef} className="w-2/3 flex flex-col items-center justify-center text-center px-6">
                    <h1 className="text-7xl font-extrabold text-white shadow-md">
                        Unleash Your Creativity: Your AI Assistant for Perfect Tweets and Captions!
                    </h1>
                </div>
            ...
            <div ref={descriptionRef} className="absolute w-1/2 mx-auto top-[80vh] left-16 p-6">
                ...
                >
                    ...
                    <p className="mt-4 text-xl leading-relaxed text-gray-300">
                        This tweet post app is designed to enhance your social media experience, offering an interactive and personalized way to create engaging content. With an AI-powered chatbot, users can brainstorm ideas, craft compelling tweets, and receive instant suggestions for captions and hashtags tailored to their style.
                        <br />
                        <br />
                        Example prompts include:
                        <br />
                        <br />
                        👉 “Can you suggest a catchy tweet about my recent trip?”<br />
                        👉 “What are some trending hashtags for my post?”<br />
                        👉 “Help me write a witty caption for this photo!”<br />
                        👉 “How can I make my tweets more engaging?”<br />
                        👉 “Can you give me ideas for a daily tweet challenge?”<br />
                        👉 “What are the best practices for increasing tweet engagement?”<br />
                        <br />
                        This app aims to make tweeting fun and effortless, empowering users to express themselves creatively and connect with their audience. By leveraging AI to provide real-time support and inspiration, it fosters confidence and creativity in every post.
                    </p>
                </div>
            </div>
